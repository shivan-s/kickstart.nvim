...
vim.keymap.set('n', '<leader>ff', require('telescope.builtin').find_files, { desc = 'Search [F]ind [F]iles' })
vim.keymap.set('n', '<leader>ht', require('telescope.builtin').help_tags, { desc = 'Search [H]elp [T]ags' })
vim.keymap.set('n', '<leader>cw', require('telescope.builtin').grep_string, { desc = 'Search [C]urrent [W]ord' })
vim.keymap.set('n', '<leader>lg', require('telescope.builtin').live_grep, { desc = 'Search [L]ive [G]rep' })
